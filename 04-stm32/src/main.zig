const stm32_hal = @cImport({
    ...
    @cDefine("ZIG_MAIN", {});
    @cDefine("__PROGRAM_START", {}); //bug: https://ziggit.dev/t/exploring-zig-on-stm32-with-freertos/4653 ->  https://github.com/ziglang/zig/issues/19687
    @cInclude("main.h");
});
...
export fn zigMain() void {
    while (true) {
        stm32_hal.HAL_GPIO_TogglePin(stm32_hal.LD2_GPIO_Port, stm32_hal.LD2_Pin);
