...
pub fn build(b: *std.Build) void {
    ...
    blinky_exe.addIncludePath(b.path("Drivers/STM32F4xx_HAL_Driver/Inc"));
    blinky_exe.addIncludePath(b.path("Drivers/STM32F4xx_HAL_Driver/Inc/Legacy"));
    blinky_exe.addIncludePath(b.path("Drivers/CMSIS/Device/ST/STM32F4xx/Include"));
    blinky_exe.addIncludePath(b.path("Drivers/CMSIS/Include"));

    // Startup file
    blinky_exe.addAssemblyFile(b.path("startup_stm32f401xe.s"));
    ...
    blinky_exe.addCSourceFiles(.{
        ...
        .flags = &.{ "-Og", "-std=c11", "-DUSE_HAL_DRIVER", "-DSTM32F401xE" },
    });

    blinky_exe.link_gc_sections = true;
    blinky_exe.link_data_sections = true;
    blinky_exe.link_function_sections = true;
    blinky_exe.setLinkerScriptPath(b.path("./STM32F401RETx_FLASH.ld"));
